      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        ...
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-semibold text-slate-800 mb-2">Create your account</h1>
            <p className="text-slate-600">Join GoCart and start shopping today</p>
          </div>
          ...
          <SignUp 
            ...
            path="/sign-up"
            signInUrl="/sign-in"
            fallbackRedirectUrl={process.env.NEXT_PUBLIC_CLERK_SIGN_UP_FALLBACK_REDIRECT_URL || "/onboarding"}
          />
        </div>
      </div>
    </div>
